...
let HelloNear = (_dec = NearBindgen({}), _dec2 = view(), _dec3 = view(), _dec4 = view(), _dec5 = call({}), _dec6 = call({}), _dec7 = call({
  payableFunction: true
}), _dec(_class = (_class2 = class HelloNear {
  message = "Hello";
  name = "name";
  accountName = "username";
  walletUsername = "test_wallet";
  profileUrl = "gg";
  ...
  set_account({
    ...
    log(`Saving greeting ${accountName}`);
    this.accountName = accountName;
    this.walletUsername = walletUsername;
    this.profileUrl = profileUrl;
  }
}, (_applyDecoratedDescriptor(_class2.prototype, "get_greeting", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "get_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_name", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "get_name"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_account", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "get_account"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_greeting", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "set_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_name", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "set_name"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_account", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "set_account"), _class2.prototype)), _class2)) || _class);
...
function set_name() {
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.set_name(_args);
  HelloNear._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
...
function get_name() {
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.get_name(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
...
export { get_account, get_greeting, get_name, set_account, set_greeting, set_name };
